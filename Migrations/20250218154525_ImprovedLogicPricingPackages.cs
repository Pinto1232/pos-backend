...
namespace PosBackend.Migrations
{
    ...
    public partial class ImprovedLogicPricingPackages : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "CustomPackageSelectedAddOn",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomPackageSelectedAddOn", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CustomPackageSelectedAddOn_AddOns_AddOnId",
                        column: x => x.AddOnId,
                        principalTable: "AddOns",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CustomPackageSelectedAddOn_PricingPackages_PricingPackageId",
            ...
            migrationBuilder.CreateTable(
                name: "CustomPackageSelectedFeature",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomPackageSelectedFeature", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CustomPackageSelectedFeature_CoreFeatures_FeatureId",
                        column: x => x.FeatureId,
                        principalTable: "CoreFeatures",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CustomPackageSelectedFeature_PricingPackages_PricingPackage~",
                        column: x => x.PricingPackageId,
                        principalTable: "PricingPackages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomPackageUsageBasedPricing", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomPackageSelectedAddOn_AddOnId",
                table: "CustomPackageSelectedAddOn",
                column: "AddOnId");

            migrationBuilder.CreateIndex(
                name: "IX_CustomPackageSelectedAddOn_PricingPackageId",
                table: "CustomPackageSelectedAddOn",
                column: "PricingPackageId");

            migrationBuilder.CreateIndex(
                name: "IX_CustomPackageSelectedFeature_FeatureId",
                table: "CustomPackageSelectedFeature",
                column: "FeatureId");

            migrationBuilder.CreateIndex(
                name: "IX_CustomPackageSelectedFeature_PricingPackageId",
                table: "CustomPackageSelectedFeature",
                column: "PricingPackageId");

            migrationBuilder.CreateIndex(
                name: "IX_CustomPackageUsageBasedPricing_PricingPackageId",
