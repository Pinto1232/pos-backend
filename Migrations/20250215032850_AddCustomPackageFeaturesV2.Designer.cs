...
namespace PosBackend.Migrations
{
    ...
    [Migration("20250215032850_AddCustomPackageFeaturesV2")]
    partial class AddCustomPackageFeaturesV2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PosBackend.Models.AddOn", b =>
                {
                    ...
                    b.PrimitiveCollection<List<int>>("Dependencies")
                        .IsRequired()
                        .HasColumnType("integer[]");
